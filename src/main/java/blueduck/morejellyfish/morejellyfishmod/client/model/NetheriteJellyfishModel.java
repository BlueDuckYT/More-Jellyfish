 ...
 */
@OnlyIn(Dist.CLIENT)
public class NetheriteJellyfishModel extends EntityModel<NetheriteJellyfishEntity> {
    ...
    public NetheriteJellyfishModel() {
    ...
    @Override
    public void setRotationAngles(NetheriteJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
