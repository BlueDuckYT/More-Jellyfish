 ...
 */
@OnlyIn(Dist.CLIENT)
public class IronJellyfishModel extends EntityModel<IronJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(IronJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
