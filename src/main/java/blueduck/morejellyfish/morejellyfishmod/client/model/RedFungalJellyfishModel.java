 ...
 */
@OnlyIn(Dist.CLIENT)
public class RedFungalJellyfishModel extends EntityModel<RedFungalJellyfishEntity> {
    ...
    public RedFungalJellyfishModel() {
    ...
    @Override
    public void setRotationAngles(RedFungalJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
