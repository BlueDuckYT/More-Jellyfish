 ...
 */
@OnlyIn(Dist.CLIENT)
public class EmeraldJellyfishModel extends EntityModel<EmeraldJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(EmeraldJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
