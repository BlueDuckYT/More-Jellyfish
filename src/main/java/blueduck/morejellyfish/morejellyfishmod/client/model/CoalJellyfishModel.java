 ...
 */
@OnlyIn(Dist.CLIENT)
public class CoalJellyfishModel extends EntityModel<CoalJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(CoalJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
