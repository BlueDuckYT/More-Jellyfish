 ...
 */
@OnlyIn(Dist.CLIENT)
public class SkellyfishModel extends EntityModel<SkellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(SkellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
