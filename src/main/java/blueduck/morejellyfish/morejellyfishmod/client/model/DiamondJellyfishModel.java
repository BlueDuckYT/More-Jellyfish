 ...
 */
@OnlyIn(Dist.CLIENT)
public class DiamondJellyfishModel extends EntityModel<DiamondJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(DiamondJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
