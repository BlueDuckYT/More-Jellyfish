 ...
 */
@OnlyIn(Dist.CLIENT)
public class GoldJellyfishModel extends EntityModel<GoldJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(GoldJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
