 ...
 */
@OnlyIn(Dist.CLIENT)
public class BrownFungalJellyfishModel extends EntityModel<BrownFungalJellyfishEntity> {
    ...
    public BrownFungalJellyfishModel() {
    ...
    @Override
    public void setRotationAngles(BrownFungalJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
