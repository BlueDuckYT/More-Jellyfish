 ...
 */
@OnlyIn(Dist.CLIENT)
public class ClayJellyfishModel extends EntityModel<ClayJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(ClayJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
