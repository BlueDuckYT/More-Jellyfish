 ...
 */
@OnlyIn(Dist.CLIENT)
public class GlowstoneJellyfishModel extends EntityModel<GlowstoneJellyfishEntity> {
    ...
    public GlowstoneJellyfishModel() {
    ...
    @Override
    public void setRotationAngles(GlowstoneJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
