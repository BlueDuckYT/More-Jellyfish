 ...
 */
@OnlyIn(Dist.CLIENT)
public class RedstoneJellyfishModel extends EntityModel<RedstoneJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(RedstoneJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
