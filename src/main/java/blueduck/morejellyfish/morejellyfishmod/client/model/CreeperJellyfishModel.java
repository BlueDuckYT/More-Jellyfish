 ...
 */
@OnlyIn(Dist.CLIENT)
public class CreeperJellyfishModel extends EntityModel<CreeperJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(CreeperJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
