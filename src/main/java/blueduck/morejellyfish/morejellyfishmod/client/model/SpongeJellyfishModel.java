 ...
 */
@OnlyIn(Dist.CLIENT)
public class SpongeJellyfishModel extends EntityModel<SpongeJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(SpongeJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
