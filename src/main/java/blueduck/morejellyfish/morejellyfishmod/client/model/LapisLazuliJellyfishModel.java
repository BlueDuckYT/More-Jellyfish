 ...
 */
@OnlyIn(Dist.CLIENT)
public class LapisLazuliJellyfishModel extends EntityModel<LapisLazuliJellyfishEntity> {
    ...
    public LapisLazuliJellyfishModel() {
    ...
    @Override
    public void setRotationAngles(LapisLazuliJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
