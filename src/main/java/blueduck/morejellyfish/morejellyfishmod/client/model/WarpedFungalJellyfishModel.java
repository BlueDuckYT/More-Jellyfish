 ...
 */
@OnlyIn(Dist.CLIENT)
public class WarpedFungalJellyfishModel extends EntityModel<WarpedFungalJellyfishEntity> {
    ...
    public WarpedFungalJellyfishModel() {
    ...
    @Override
    public void setRotationAngles(WarpedFungalJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
