 ...
 */
@OnlyIn(Dist.CLIENT)
public class CrimsonFungalJellyfishModel extends EntityModel<CrimsonFungalJellyfishEntity> {
    ...
    public CrimsonFungalJellyfishModel() {
    ...
    @Override
    public void setRotationAngles(CrimsonFungalJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
