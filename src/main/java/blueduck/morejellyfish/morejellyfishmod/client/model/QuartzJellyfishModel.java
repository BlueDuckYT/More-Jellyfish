 ...
 */
@OnlyIn(Dist.CLIENT)
public class QuartzJellyfishModel extends EntityModel<QuartzJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(QuartzJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
