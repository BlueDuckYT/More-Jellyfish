...
public class MoreJellyfishItems {
    ...
    public static final RegistryObject<Item> GLOWSTONE_JELLYFISH_SPAWN_EGG = ITEMS.register("glowstone_jellyfish_spawn_egg", () -> new MoreJellyfishSpawnEgg(() -> MoreJellyfishEntities.SPONGE_JELLYFISH.get(),13479464, 7628544, new Item.Properties().group(ItemGroup.MISC)));
    public static final RegistryObject<Item> QUARTZ_JELLYFISH_SPAWN_EGG = ITEMS.register("quartz_jellyfish_spawn_egg", () -> new MoreJellyfishSpawnEgg(() -> MoreJellyfishEntities.GLOWSTONE_JELLYFISH.get(),13541991, 6109716, new Item.Properties().group(ItemGroup.MISC)));
