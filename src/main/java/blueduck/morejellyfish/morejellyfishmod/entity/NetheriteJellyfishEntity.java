...
public class NetheriteJellyfishEntity extends AbstractJellyfishEntity {
    public NetheriteJellyfishEntity(EntityType<? extends AbstractFishEntity> type, World worldIn) {
        super(type, worldIn, new ItemStack((IItemProvider) MoreJellyfishItems.NETHERITE_JELLYFISH.get(), 1), (Item) MoreJellyfishItems.NETHERITE_CHUNK.get(), 0.25D, true, 200, 2, 0.25D, 0.25D, 0.1D);
    }
}
