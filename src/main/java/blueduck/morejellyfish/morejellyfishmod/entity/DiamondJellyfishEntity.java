...
public class DiamondJellyfishEntity extends AbstractJellyfishEntity {
    public DiamondJellyfishEntity(EntityType<? extends AbstractFishEntity> type, World worldIn) {
        super(type, worldIn, new ItemStack((IItemProvider) MoreJellyfishItems.DIAMOND_JELLYFISH.get(), 1), (Item)MoreJellyfishItems.DIAMOND_SHARD.get(), 0.5D, true, 200, 8, 0.9D, 0.95D, 0.4D);
    }
}
