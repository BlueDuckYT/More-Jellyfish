...
public class EmeraldJellyfishEntity extends AbstractJellyfishEntity {
    public EmeraldJellyfishEntity(EntityType<? extends AbstractFishEntity> type, World worldIn) {
        super(type, worldIn, new ItemStack((IItemProvider) MoreJellyfishItems.EMERALD_JELLYFISH.get(), 1), (Item)MoreJellyfishItems.EMERALD_FRAGMENT.get(), 0.75D, true, 200, 5, 0.75D, 0.75D, 0.2D);
    }
}
